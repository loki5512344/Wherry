    ...
    frame.show(ui, |ui| {
        ...
        ui.allocate_ui_with_layout(
            ...
            |ui| {
                            ...
                            ui.allocate_ui_with_layout(
                                ...
                                |ui| {
                                    ...
                                    let lbl = egui::Label::new(
                                        RichText::new(&tab.label).color(tcol).size(12.0),
                                    )
                                    ...
                                    let close = egui::Label::new(
                                        RichText::new("×").color(TEXT_HINT).size(14.0),
                                    )
                                    .sense(egui::Sense::click());
                ...
                // кнопка "+"
                ui.add_space(4.0);
                let plus = egui::Button::new(RichText::new("+").color(TEXT_DIM).size(15.0))
